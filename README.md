...
The effect of control variates is not substantial -- it reduces the variance by around 10% based on numerical experiements. Its implementation is fairly straightforward, except a possible pitfall that is listed at the bottom of our report. 
